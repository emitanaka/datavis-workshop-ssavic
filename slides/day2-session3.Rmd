...
.monash-orange2[The purpose of interactivity is to display more than can be achieved with persistent plot elements, and to invite the reader to engage with the plot.]
--

.pull-left[
- Mouse-over labels .monash-orange2[de-clutters] a plot

- Pan/zoom allows .monash-orange2[re-focusing] attention

- Selection allows focusing attention
 
- .monash-orange2[Linking connects] elements from multiple plots

]
--

.pull-right[
.monash-blue2[Animation] allows more information to be displayed, but developer keeps control. Beware that it is easy to .monash-blue2[forget] what was just displayed, so keeping some elements persistent, maybe faint, can be useful for the reader.
]
...
```{r echo=FALSE, fig.width=10, fig.height=8, out.width="80%"}
