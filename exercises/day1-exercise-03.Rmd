...
```{r day1-exercise-03-01s, eval = FALSE}
...
```{r day1-exercise-03-02s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-03-03s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-03-04s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-03-05s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
