...
```{r day1-exercise-02-01s, eval = FALSE}
...
```{r day1-exercise-02-02s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-02-03s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-02-04s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-02-05s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
df4 <- nass.wheat %>% 
  filter(year == 2011) 
...
```{r day1-exercise-02-06s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
df5 <- glass %>% 
...
```{r day1-exercise-02-07s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
ggplot(df5, aes(..., ...)) + 
  geom_...() + 
  facet_wrap(~..., scale = "free_y")
...
```{r day1-exercise-02-08s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-02-09s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
...
```{r day1-exercise-02-10s, eval = FALSE}
# fill all ... and change eval = FALSE to eval = TRUE when done
