---
title: "Exercise 4 Solution: Determining the best plot design"
output:
  html_document:
    toc: true
    toc_float: true
...
knitr::opts_chunk$set(
  fig.path = "images/day2-exercise-04/",
...
```{r day2-exercise-01, echo = F, fig.show='hold'}
...
```{r day2-exercise-02, echo = T, fig.height = 4}
tb_oz %>% 
  filter(year == 2012) %>%
...
```{r day2-exercise-02s, class="target", eval=T}
tb_oz %>% 
  filter(year == 2012) %>%
...
```{r day2-exercise-03s, class="target", eval=T}
tb_oz %>% 
