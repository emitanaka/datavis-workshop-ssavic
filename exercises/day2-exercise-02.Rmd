...
### Exercise 1.1: Polygon fill colour

```{r day2-exercise-02-01, echo = F, class = "target"}
knitr::include_graphics("images/day2-exercise-02/day2-exercise-01-1.png")
```
...
### Exercise 1.3:  Density plot on map

```{r day2-exercise-02-03, echo = F, class = "target"}
knitr::include_graphics("images/day2-exercise-02/day2-exercise-03-1.png")
```

```{r day2-exercise-02-03s}
# add your code here!
```
